...
4. Update the tests in `tests/test_cleaning` to reflect the changes: namely, pass the `"PT"` as an argument to the `clean_data` function on line 10. After this, running ` should still work.
